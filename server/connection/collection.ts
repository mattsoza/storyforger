...
class ConnectionCollection {
   ...
   */
  static async addOne(parent: Types.ObjectId|string, child: Types.ObjectId|string, text: string, author: Types.ObjectId|string, book:Types.ObjectId|string): Promise<HydratedDocument<Connection>> {
    const connection = new ConnectionModel({parent, child, text, author, book});
